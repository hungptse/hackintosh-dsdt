 ...
 *
 * Disassembly of SSDT-2-DptfTabl.aml, Wed Jun 12 22:30:18 2019
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00003F08 (16136)
 *     Revision         0x02
 *     Checksum         0xE2
 *     OEM ID           "DptfTa"
...
DefinitionBlock ("", "SSDT", 2, "DptfTa", "DptfTabl", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.EC0_.PMOD, IntObj)
    ...
    Scope (\_SB.PCI0.B0D4)
    {
        ...
        Method (CPL1, 0, NotSerialized)
        {
            ...
            Store (0x3A98, Index (DerefOf (Index (\_SB.PCI0.B0D4.NPCC, One)), 0x02))
    ...
    Scope (\_SB.IETM)
    {
        ...
        Method (PSVT, 0, Serialized)
        {
            If (\_SB.PCI0.LPCB.EC0.PMOD)
            {
                ...
                Name (PSV5, Package (0x01)
                {
                    0x02
                })
                Name (PSV6, Package (0x01)
                {
                    0x02
                })
                Switch (ToInteger (\_SB.TJMX))
                {
                    ...
                    Case (Zero)
                    {
                        If (LEqual (ToInteger (\_SB.SCWT), Zero))
                        {
                            Return (PSV5)
                        }
